...
def _inverted_res_block_lstm_bottleneck(inputs, expansion, stride, alpha, filters, stage=1, block_id=1, expand=True, output2=False):
...
def mobilenet_v2_ssdlite(input_image):
    ...
    links = [link1, link2, link3, link4, link5]# return 6 feature maps with different scales 
