...
from models.bottleneck_lstm.depthwise_conv_rnn import BottleneckRNN2D
...
def mobilenet_v2_ssdlite(input_image):
    ...
    x = BottleneckRNN2D(filters=80, kernel_size=(3,3), padding='same',stateful='True',return_sequences='False')(x)
    #x = Reshape((10,10,320), name='change_seq_2_singleFrame')
    #x = KL.Lambda(sliceTimestep)(x)
