...
def mobilenet_v2_ssdlite(input_image):
    ...
    x = BottleneckLSTM2D(filters=80, kernel_size=3, padding='same',stateful=True, return_sequences=True)(x)
    #x = ConvLSTM2D(filters=80, kernel_size=(3,3), padding='same',stateful='False',return_sequences='False')(x)
