...
from models.graphs.baseline_and_bottlenecklstm_dropTdForBNandConcat import mobilenet_v2_ssdlite #this is the backbone with bottelneck Lstm
...
def mobilenet_v2_ssd(image_size,
    ...
    '''
    priorbox2 = AnchorBoxes(img_height, img_width, this_scale=scales[0], next_scale=scales[1],
                                    aspect_ratios=aspect_ratios[0],
    ...
    priorbox3 = AnchorBoxes(img_height, img_width, this_scale=scales[1], next_scale=scales[2],
    ...
    priorbox4 = AnchorBoxes(img_height, img_width, this_scale=scales[2], next_scale=scales[3],
    ...
    priorbox5 = AnchorBoxes(img_height, img_width, this_scale=scales[3], next_scale=scales[4],
